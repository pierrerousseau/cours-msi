...
\subsubsection*{localisation(Service de recherche, Adhérent)}
\begin{itemize}
...
\subsubsection*{remboursement(Adhérent, Secrétariat)}
\begin{itemize}
    \item code-livre
\end{itemize}
...
%
   \hline
                  & \multicolumn{4}{| c |}{Accueil} & \multicolumn{4}{| c |}{Service des recherches} & \multicolumn{4}{| c |}{Service des prêts} & \multicolumn{4}{| c |}{Secrétariat} \\
   \hline
